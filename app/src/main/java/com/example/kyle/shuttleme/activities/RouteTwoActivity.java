...
public class RouteTwoActivity extends FragmentActivity implements RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CameraUpdate center = CameraUpdateFactory.newLatLng(new LatLng(10.641788, -61.399958));
        ...
        */
        ...
        ParseUser.logInInBackground("Shuttle2", "shuttleMaster_2");
            ...
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject object, ParseException e) {
                    if (e == null) {
                        ...
                        //Toast.makeText(RouteTwoActivity.this, "Parse Query Successful", Toast.LENGTH_LONG).show();
                        marker = map.addMarker(new MarkerOptions()
                                .position(cPoint)
                                .snippet("Lat:" + Location.getLatitude() + "Lng" + Location.getLongitude())
                        ...
                        Toast.makeText(RouteTwoActivity.this, "Fetching Location data...", Toast.LENGTH_LONG).show();
                        e.printStackTrace();
                    }
                }
