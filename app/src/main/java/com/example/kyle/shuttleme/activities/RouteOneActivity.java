...
public class RouteOneActivity extends FragmentActivity implements RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CameraUpdate center = CameraUpdateFactory.newLatLng(new LatLng(10.639246, -61.400617));
            ...
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject object, ParseException e) {
                    if (e == null) {
                        ...
                        //Toast.makeText(RouteFourActivity.this, "Parse Query Successful", Toast.LENGTH_LONG).show();
                        marker = map.addMarker(new MarkerOptions()
                                .position(cPoint)
                                .snippet("Lat:" + Location.getLatitude() + "Lng" + Location.getLongitude())
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.bus_marker))
                        ...
                        Toast.makeText(RouteOneActivity.this, "Fetching Location data...", Toast.LENGTH_LONG).show();
                        e.printStackTrace();
                    }
                }
