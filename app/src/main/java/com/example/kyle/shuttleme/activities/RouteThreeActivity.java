...
public class RouteThreeActivity extends FragmentActivity implements RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CameraUpdate center = CameraUpdateFactory.newLatLng(new LatLng(10.647338, -61.394387));
        ...
        */
        ...
        ParseUser.logInInBackground("Shuttle3", "shuttleMaster_3");
            ...
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject object, ParseException e) {
                    if (e == null) {
                        ...
                        //Toast.makeText(RouteThreeActivity.this, "Parse Query Successful", Toast.LENGTH_LONG).show();
                        marker = map.addMarker(new MarkerOptions()
                                .position(cPoint)
                                .snippet("Lat:" + Location.getLatitude() + "Lng" + Location.getLongitude())
                        ...
                        Toast.makeText(RouteThreeActivity.this, "Fetching Location data...", Toast.LENGTH_LONG).show();
                        e.printStackTrace();
                    }
                }
